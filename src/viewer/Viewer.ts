...
export class Viewer extends EventEmitter {
     ...
     * @returns {Promise<Node>} The node that was navigated to.
     */
     ...
     * photo.
     *
     * @returns {Promise<number[]>} The basic coordinates of the current
     * photo at the center for the viewport.
     */
     ...
     *
     * @returns {Promise<number>} The photo's current zoom level.
     */
